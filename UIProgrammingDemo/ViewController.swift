...
class ViewController: UIViewController, UITableViewDelegate, UITableViewDataSource {
    ...
    var thingsLabel = UILabel(frame: CGRect(x: 10, y: 45, width: UIScreen.mainScreen().bounds.width - 20, height: 60))
    ...
    override func viewDidLoad() {
        ...
        thingsLabel.text = "Space needle, science center, aquarium, movie theaters, clam chowder, Pike's Place Market, rocky beaches, original Starbucks"
